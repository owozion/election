        ...
        <div class="row">
            <main>
                <div class="container-fluid px-4">
                    <div class="card mb-4">
                        <div class="card-body">
                               <h1 class="profile" style="color:green; text-align:centre;">Results By Polling Unit</h1>
                        </div>
                    </div>
                    <div class="card mb-4"> 
                               ...
                               <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo $pro['polling_unit_name'];?></td>
                                            <td><?php echo $pro['party_abbreviation'];?></td>
                                            <td><?php echo $pro['party_score'];?></td>
                                            <td><?php echo $pro['date_entered'];?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
